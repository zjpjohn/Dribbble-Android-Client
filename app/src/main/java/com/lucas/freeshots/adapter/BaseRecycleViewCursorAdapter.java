package com.lucas.freeshots.adapter;
...
/**
 * 此文件来自网络(https://github.com/Frank-Zhu/AndroidRecyclerViewDemo)，原作者信息如下：
 * Author:    ZhuWenWu
 * Version    V1.0
 ...
 */
public abstract class BaseRecycleViewCursorAdapter<VH extends RecyclerView.ViewHolder>
     ...
     */
    public BaseRecycleViewCursorAdapter(Context context, Cursor c) {
     ...
     */
    public BaseRecycleViewCursorAdapter(Context context, Cursor c, int flags) {
